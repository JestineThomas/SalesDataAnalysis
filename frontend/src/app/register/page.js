    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-teal-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 px-4">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        ...
        <p className="mt-2 text-xs sm:text-sm text-slate-300">
          Create an analyst or administrator account
        </p>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-6 sm:px-10 shadow-2xl rounded-3xl border border-slate-100">
          <div className="mb-6">
            ...
            <p className="text-xs text-slate-500 mt-0.5">Start monitoring business performance</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="w-full pl-10 pr-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-teal-500 focus:bg-white transition appearance-none"
                >
                  <option value="analyst">Analyst (View Analytics & Manage Records)</option>
                  <option value="admin">Administrator (Full Access & Delete Permissions)</option>
                </select>
              </div>
            </div>
